...
class Porter implements Serializable
{
	...
	public static boolean equivStems(Comparable word1, ArrayList<Comparable<String>> w2)
	{
		...
		{	
			if(equivStems(word1.toString(), word2.toString()))
				return true;
		}
		return false;
	}
	public static boolean equivStems(String word1, String word2)
	{
		...
		{
			boolean value = stem(word1).equals(stem(word2));
			equivCache.setValue(word1, word2, value);
			return value;
		}
	}
	...
	private String stem0(String word)
	{
