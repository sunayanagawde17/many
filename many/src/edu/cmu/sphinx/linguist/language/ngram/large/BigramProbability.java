...
/**
 * Represents a word ID (second word of a bigram), a bigram probability ID, a
 * backoff probability ID, and the location of the first trigram entry.
 */
class BigramProbability
{
	 ...
	 * 
	 * @param which
	 *            which follower of the first word is this bigram
	 * @param wordID
	 *            the ID of the second word in a bigram
	 * @param probabilityID
	 *            the index into the probability array
	 * @param backoffID
	 *            the index into the backoff probability array
	 * @param firstTrigramEntry
	 *            the first trigram entry
	 */
	public BigramProbability(int which, int wordID, int probabilityID,
			int backoffID, int firstTrigramEntry)
	{
		this.which = which;
		this.wordID = wordID;
